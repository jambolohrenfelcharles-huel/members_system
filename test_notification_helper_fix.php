<?php
/**
 * Test script to verify notification helper fix
 * This tests the $members_table variable fix
 */

echo "<h1>Notification Helper Fix Test</h1>";
...
try {
    ...
    if ($isPostgreSQL) {
        ...
        echo "<ul>";
        echo "<li>✅ Fixed \$members_table variable definition</li>";
        echo "<li>✅ Removed undefined variable warning</li>";
